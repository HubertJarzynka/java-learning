...
class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf() {
        ...
        //Given
        LibraryUser libraryUser = new LibraryUser("Olga", "Kotur", "97001234564");
        LibraryUser libraryUser2 = new LibraryUser("Michał", "Nowak", "93215456879");
        LibraryUser libraryUser3 = new LibraryUser("Paweł", "Koszałka", "92212313212");
